...
if env.cache('HEROKU_REDIS_TEAL_URL'):
    HEROKU_REDIS_URL = 'HEROKU_REDIS_TEAL_TLS_URL' if DEPLOY_ENVIRONMENT == 'production' else 'HEROKU_REDIS_TEAL_URL'
else:
    HEROKU_REDIS_URL = 'REDIS_TLS_URL' if DEPLOY_ENVIRONMENT == 'production' else 'REDIS_URL'
