...
SECTOR = Sector(
    ...
    data collection has reduced the latency period from 45 days to eight hours.
            """),
            video_url=None,
            published_study_url="https://www.microsoft.com/en-us/research/people/cutrell/"
    ...
    with malnourished children.
            ...
            commcare_app_url="https://www.commcarehq.org/exchange/3fb6383acfdc9e726cb089fba4722ee2/info/"
                             "?__hstc=240960668.41b1f79d5eb5c17e0c46e4237991c19b.1518524627256."
                             "1518774288328.1518783005958.15&__hssc=240960668.31.1518783005958"
                             "&__hsfp=2464441440",
        ),
        Project(
            name=ugettext_lazy(
    ...
    application calculates and records children’s weight-for-age Z scores and MUAC.
            """),
            video_url="https://youtu.be/YS4NFMCwkm4?list=PLVmwIEfrcKqnGhas9Vy4CmPEvG9xVvQdr",
            published_study_url=None,
            commcare_app_url=None,
        ),
        Project(
    ...
    progress in becoming sufficiently nourished to undergo cleft palate surgery.
            ...
            video_url=None,
            published_study_url=None,
            commcare_app_url="https://www.commcarehq.org/exchange/8bd844d12202009cc17a03dc01d0cbaa/info/"
                             "?__hstc=240960668.08ee0e6075b9e3e4b1f3bcfe39a26c87.1477145574241."
                             "1477257909331.1477285607734.7&__hssc=240960668.27.1477285607734&__"
                             "hsfp=4011894190",
        ),
    ],
