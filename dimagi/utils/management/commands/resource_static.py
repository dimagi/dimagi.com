...
class Command(BaseCommand):
    ...
    def overwrite_resources(self, resources, sha=None):
        ...
        default_cache.set(RESOURCE_PREFIX % sha, resources, 86400)
    ...
    def handle(self, **options):
        ...
        if options['clear']:
            ...
            default_cache.delete_pattern(RESOURCE_PREFIX % '*')

        current_sha = self.current_sha()
        existing_resources = default_cache.get(RESOURCE_PREFIX % current_sha, None)
