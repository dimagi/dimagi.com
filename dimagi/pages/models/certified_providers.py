...
class CertifiedProvidersPost(object):

    def __init__(self, data):
        self.title = data['title']

        from dimagi.data.certified_providers import get_category_by_slug
    ...
    def canonical_link(self):
        from dimagi.data.certified_providers.canonical import get_canonical_link
