...
urlpatterns = [
    ...
    url(r'^referral-commcare/$', redirect.temp_redirect('commcare'), name='referral_commcare'),
    url(r'^toolkits/digital-health-interventions/$', redirect.temp_redirect('toolkits'), name='digital-health-interventions'),
