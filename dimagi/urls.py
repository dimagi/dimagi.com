...
urlpatterns = [
    ...
    url(r'^referral-commcare/$', pages.commcare.temporary_redirect_commcare,
        name='referral-commcare'),
    url(r'^toolkits/digital-health-interventions/$', pages.toolkits.temporary_redirect_toolkits,
